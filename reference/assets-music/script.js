...
const songsList = [
    {
        ...
        title: 'Celebrity',
        author: 'IU',
        path: './assets-music/music/Celebrity.mp3',
        bgPath: './assets-music/image/2.jpg',
        time: 0
    },
    {
        id: 'xxx-02',
        title: '再飞行',
        author: '逃跑计划',
        path: './assets-music/music/zaifeixing.mp3',
        bgPath: './assets-music/image/xingyouji2.png',
        time: 0
    },

    {
        ...
        title: 'The Rain',
        author: '久石让',
        path: './assets-music/music/The Rain.mp4',
        bgPath: './assets-music/image/3.jpg',
        time: 0
    }
];
